...
class _OrderDetailState extends State<OrderDetail> {
  ...
  Future<String?> getUserToken(String userId) async {
    try {
      var document = await FirebaseFirestore.instance.collection('tokens').doc(userId).get();
                ...
                children: [
                  RoundedButton(
                    ...
                    press: () {
                      ...
                      pvm
                          .updateOrderStatus(widget.order.id, 2)
                          .then(
                            (value) => Provider.of<SellerViewModel>(
                              context,
                              listen: false,
                            ).updateSellerBalance(
                        ...
                        (value) async {
                          ...
                          sendNotification(token, "Order Finished!", "Your Order #[${widget.orderNumber.substring(0, 6)}] is ready to pick up!");
                        },
                      ).then(
